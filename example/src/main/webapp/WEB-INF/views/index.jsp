        ...
        <div class="col-md-3 mb-2 mb-md-0">
            <a href=""
               class="d-inline-flex link-body-emphasis text-decoration-none">
                <svg class="bi" width="50" height="42" role="img">
                    <image href="salad.png" width="50" height="42" />
                </svg>
                <p id="titleId" class=".nav col-md-auto nav-link px-2">VeganLoadMap</p>
            </a>
        </div>
...
<h2>Hello VeganLoadMap / Location for Map / index.jsp</h2>
<hr>
