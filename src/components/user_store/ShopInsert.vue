...
<!--      </select>-->
    ...
    <div class="field">
      <b>가게 이름</b>
      <input type="text" v-model="state.form.storename">
    </div>
    <div class="field">
      <b>사업자 등록 번호</b>
      <input type="text" v-model="state.form.storenumber">
    </div>
    <div class="field">
      <b>사업자 등록증 파일 업로드</b>
      <input type="file" ref="fileInput" @change="onFileChange" />
<!--      <button @click="uploadImage()">확인</button>-->
